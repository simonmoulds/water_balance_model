...
class RainfallPartition(object):
    ...
    def __init__(self, RainfallPartition_variable):
        ...
        # self.global_var = LandSurface_variable
    ...
    def dynamic(self):
        ...
        cond111 = np.all((comp_sto == False), axis=2)
        ...
        xx = np.concatenate((np.zeros((self.var.nFarm, self.var.nLC, 1, self.var.nCell)), wx[:,:,:-1,:]), axis=2)
